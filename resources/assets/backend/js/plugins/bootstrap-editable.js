...
!function (a) {
    ...
    b.prototype = {
        constructor: b, init: function () {
            ...
            for (var b = [],
                     c = 0; c < a.length; c++)b.push('<option value="' + a[c][0] + '">' + a[c][1] + "</option>");
            return b.join("\n")
        }, fillDay: function () {
    ...
    a.extend(a.fn.editableform.Constructor.prototype, {
        initTemplate: function () {
            ...
            for (var f = this.$form.find(".editable-buttons"), g = c ? [d] : this.input.options.inputclass.split(" "),
                     h = 0; h < g.length; h++)"input-lg" === g[h].toLowerCase() && f.find("button").removeClass("btn-sm").addClass("btn-lg")
        }
