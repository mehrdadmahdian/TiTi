    ...
    $.extend(Datepicker.prototype, {
	   ...
	   @param  input  element - the input field attached to the date picker or
        ...
        _updateDatepicker: function(inst) {
            ...
            // Modified By Dadehpardaz.com 26th Dec 2015
//            inst.dpDiv.find('select').each(function(){
//            	$(this).select2({
	 ...
	 */
        ...
        _generateHTML: function(inst) {
            ...
            var prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                ...
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-prev btn btn-link ui-state-disabled" title="'+ prevText +'">' + (isRTL ? '<i></i>' : '<i></i>') + '</a>'));
            ...
            var next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                ...
                ' title="' + nextText + '">' + (isRTL ? '<i class="fa fa-arrow-circle-o-left"></i>' : '<i></i>') + '</a>' :
                (hideIfNoPrevNext ? '' : '<a class="ui-datepicker-next btn btn-link ui-state-disabled" title="'+ nextText + '">' + (isRTL ? '<i></i>' : '<i></i>') + '</a>'));
