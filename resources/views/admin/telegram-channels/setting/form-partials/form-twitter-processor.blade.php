<div class="col-sm-12">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="tags" placeholder="کلمه ناشایست" class="tm-input form-control tm-input-info"/>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" name="tags" placeholder="sample_user_5218" class="tm-input form-control tm-input-info"/>
